...
def DenseNet(
    ...
    x = layers.Conv2D(64, (16, 16), strides=16, padding="same", use_bias=False, name="conv1/conv")(x)

    #from robust resnet18
    #Conv2D(96, (16, 16), strides=16,
